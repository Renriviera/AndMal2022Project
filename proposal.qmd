...
# Add all derived features to both dataframes ----
...
# Add remaining derived features to both dataframes ----
...
# Dex features
dex_apis_present <- dex_apis[dex_apis %in% names(andmal_before)]
...
# Crypto features
crypto_apis_present  <- crypto_apis[crypto_apis %in% names(andmal_before)]
base64_apis_present  <- base64_apis[base64_apis %in% names(andmal_before)]
...
# IPC features
ipc_present <- ipc_all[ipc_all %in% names(andmal_before)]
